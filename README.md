...
| Buro (1994–1999), "Logistello" (7 papers) | [replication-logistello](https://github.com/akitenkrad/rs-logistello) | Rust + Python | The world-champion-beating Othello program. Pattern-evaluation functions learned from expert games, ProbCut / Multi-ProbCut probabilistic forward pruning, and self-play opening-book learning — the methodological precursor to modern learned game AI. |
