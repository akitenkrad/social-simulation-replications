...
19 replication implementations of social-simulation papers, grouped by modeling paradigm: 5 Classic agent-based models; 13 LLM-based social simulation; 1 Game AI / other.
